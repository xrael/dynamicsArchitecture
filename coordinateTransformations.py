...
def ROT1_dot(alpha, alpha_dot):
    ...
    DCM_dot = alpha_dot * np.array([[0,      0,            0],
                                    [0,      -sin_al,  cos_al],
                                    [0,     -cos_al,  -sin_al]])
...
def ROT2_dot(alpha, alpha_dot):
    ...
    DCM_dot = alpha_dot * np.array([[-sin_al, 0, -cos_al],
                                    [0,      0,       0],
                                    [cos_al, 0,  -sin_al]])
...
def ROT3_DOT(alpha, alpha_dot):
    ...
    DCM_dot = alpha_dot * np.array([[-sin_al,    cos_al, 0],
                                    [-cos_al,   -sin_al, 0],
                                    [0,         0,      0]])

    return DCM_dot

def ROT3_DDOT(alpha, alpha_dot, alpha_ddot):
    """
    ...
    DCM_dot = alpha_dot**2 * np.array([[-cos_al, -sin_al, 0],
                                       [sin_al,  -cos_al, 0],
                                       [0,         0,     0]]) +\
              alpha_ddot * np.array([[-sin_al,    cos_al, 0],
                                    [-cos_al,   -sin_al, 0],
                                    [0,         0,      0]])
