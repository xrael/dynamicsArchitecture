...
cone_angle_inc = np.deg2rad(60) # cone angle around the constraint vector
...
Vect = control_force_history['Vect']
...
plt.figure()
plt.hold(True)
plt.plot(time, sigma_BN[:,0], label='$\sigma_{BN_1}$', color='r')
plt.plot(time, sigma_BN[:,1], label='$\sigma_{BN_2}$', color='g')
plt.plot(time, sigma_BN[:,2], label='$\sigma_{BN_3}$', color='b')
...
plt.figure()
plt.hold(True)
plt.plot(time, np.rad2deg(w_BN[:,0]), label='$\omega_{BN_1}$', color='r')
plt.plot(time, np.rad2deg(w_BN[:,1]), label='$\omega_{BN_1}$', color='g')
plt.plot(time, np.rad2deg(w_BN[:,2]), label='$\omega_{BN_1}$', color='b')
plt.plot(time, np.rad2deg(w_RN_B[:,0]), '--', label='$\omega_{RN_1}$', color='r')
plt.plot(time, np.rad2deg(w_RN_B[:,1]), '--', label='$\omega_{RN_2}$', color='g')
plt.plot(time, np.rad2deg(w_RN_B[:,2]), '--', label='$\omega_{RN_3}$', color='b')
...
plt.figure()
plt.hold(True)
plt.plot(time, rw_Omega_1 * 60.0/(2*np.pi), label='$\Omega_{RW-1}$')
plt.plot(time, rw_Omega_2 * 60.0/(2*np.pi), label='$\Omega_{RW-2}$')
plt.plot(time, rw_Omega_3 * 60.0/(2*np.pi), label='$\Omega_{RW-3}$')
plt.plot(time, rw_Omega_4 * 60.0/(2*np.pi), label='$\Omega_{RW-4}$')
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time, rw_Omega_dot_1 * 60.0/(2*np.pi), label='$\dot\Omega_{RW-1}$')
plt.plot(time, rw_Omega_dot_2 * 60.0/(2*np.pi), label='$\dot\Omega_{RW-2}$')
plt.plot(time, rw_Omega_dot_3 * 60.0/(2*np.pi), label='$\dot\Omega_{RW-3}$')
plt.plot(time, rw_Omega_dot_4 * 60.0/(2*np.pi), label='$\dot\Omega_{RW-4}$')
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time, rw_us1 * 1000, label='$u_{s_1}$')
plt.plot(time, rw_us2 * 1000, label='$u_{s_2}$')
plt.plot(time, rw_us3 * 1000, label='$u_{s_3}$')
plt.plot(time, rw_us4 * 1000, label='$u_{s_4}$')
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time, sigma_BR[:,0], label='$\sigma_1$', color='r')
plt.plot(time, sigma_BR[:,1], label='$\sigma_2$', color='g')
plt.plot(time, sigma_BR[:,2], label='$\sigma_3$', color='b')
#plt.ylim([-0.01, 0.01])
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time, np.rad2deg(w_BR_B[:,0]), label='$\omega_1$', color='r')
plt.plot(time, np.rad2deg(w_BR_B[:,1]), label='$\omega_2$', color='g')
plt.plot(time, np.rad2deg(w_BR_B[:,2]), label='$\omega_3$', color='b')
plt.plot(time, np.rad2deg(w_BR_B_desired[:,0]), '--', label='$\omega_{1d}$', color='r')
plt.plot(time, np.rad2deg(w_BR_B_desired[:,1]), '--', label='$\omega_{2d}$', color='g')
plt.plot(time, np.rad2deg(w_BR_B_desired[:,2]), '--', label='$\omega_{3d}$', color='b')
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.savefig('figures_tracking/det_Q.pdf', bbox_inches='tight', dpi=300)
plt.close()

plt.figure()
plt.hold(True)
plt.plot(time, Vect[:,0],label="v_1")
plt.plot(time, Vect[:,1],label="v_2")
plt.plot(time, Vect[:,2],label="v_3")
plt.xlabel("Time [sec]")
plt.ylabel("v_T", size=18)
plt.legend()
plt.savefig('figures_tracking/Vect.pdf', bbox_inches='tight', dpi=300)
plt.close()
...
ax.add_patch(patch4)
plt.hold(True)
plt.plot(right_as*180/np.pi, dec*180/np.pi,'.',markersize=2,label='Camera boresight vector tip')
...
plt.hold(True)
plt.plot(right_as_inc*180/np.pi, dec_inc*180/np.pi,'.',markersize=2,label='Antenna boresight vector tip')
...
plt.figure()
plt.hold(True)
plt.plot(time, np.rad2deg(angle_1), label='$\\theta_1$')
plt.axhline(np.rad2deg(cone_angle_1), label='$\\theta_{min1}$', linestyle='-.', color='k')
plt.axhline(np.rad2deg(angle_thres_1), label='$\\theta-{thres_{min1}}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_1_max), label='$\\theta-{thres_{max1}}}$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.axhline(np.rad2deg(angle_thres_2), label='$\\theta_{thres-{min2}}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_2_max), label='$\\theta_{thres-{max2}}}$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time, np.rad2deg(angle_3), label='$\\theta_3$')
plt.axhline(np.rad2deg(cone_angle_3), label='$\\theta_{min3}$', linestyle='-.', color='k')
plt.axhline(np.rad2deg(angle_thres_3), label='$\\theta_{thres-{min3}}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_3_max), label='$\\theta_{thres-{max3}}}$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
