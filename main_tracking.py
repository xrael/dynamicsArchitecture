...
plt.plot(time[::10], np.rad2deg(w_RN_B[::10,0]), '--', label='$\omega_{RN_1}$', color='r')
plt.plot(time[::10], np.rad2deg(w_RN_B[::10,1]), '--', label='$\omega_{RN_2}$', color='g')
plt.plot(time[::10], np.rad2deg(w_RN_B[::10,2]), '--', label='$\omega_{RN_3}$', color='b')
...
plt.axhline(np.rad2deg(angle_thres_1), label='$\\theta_{01}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_1_max), label='$\\theta_{01} + \psi$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.axhline(np.rad2deg(angle_thres_2), label='$\\theta_{02}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_2_max), label='$\\theta_{02} + \psi$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.axhline(np.rad2deg(angle_thres_3), label='$\\theta_{03}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_3_max), label='$\\theta_{03} + \psi$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time[::10], np.rad2deg(angle_4[::10]), label='$\\theta_4$')
plt.axhline(np.rad2deg(cone_angle_4), label='$\\theta_{min4}$', linestyle='-.', color='k')
plt.axhline(np.rad2deg(angle_thres_4), label='$\\theta_{04}$', linestyle='--', color='c')
plt.axhline(np.rad2deg(angle_thres_4_max), label='$\\theta_{04} + \psi$', linestyle='--', color='m')
plt.ylim([0,180])
plt.legend(prop={'size':22})
plt.xlabel("$t$ $[sec]$", size=27)
...
plt.figure()
plt.hold(True)
plt.plot(time[::10], np.rad2deg(angle_inc[::10]), label='$\\theta_{5}$')
